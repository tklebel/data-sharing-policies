...
Here we hold originator benefit constant at .1, and contrast sharing mandates (sharing mandate is either )
...
This is highly peculiar: If sharing is not mandated, incentives work as anticipated: higher incentives lead to higher sharing (but overall still low sharing, up to about 30% of groups sharing). If sharing is mandated, no incentives lead to the highest sharing percentage.

Another issue that seems to be a coding error is observed when looking at the sum of resources: these are very low for "No mandate", although data is being shared. This is very unexpected (redistribution of resources should not depend on the mandate, only on sharing behaviour).
