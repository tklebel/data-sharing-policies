...
in the main manuscript is the fifth column (.4).
...
## Figure 1 - Panel A
Again, the column to compare to the main manuscript is the fifth. The manuscript 
uses .15 for sigma.
...
## Figure 1 - Panel A
The column to compare to the main manuscript is the fifth. The manuscript 
uses 1 for gain.
