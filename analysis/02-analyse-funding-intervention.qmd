...
the funding agency. Maybe counterintuitively, a low rate of funded teams leads 
...
@fig-vary-share-of-funded-teams). This is obviously tied to funding selectivity
...
speaks to our research in ON-MERRIT: with such policies and incentives, there 
...
situation where some teams simply are not able to take data sharing up due to a
...
- Why is no sharing happening with network effects? Do we need to revise the 
simulation here?
