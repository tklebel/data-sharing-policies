...
sciences, such as in physics, with research in the social sciences and
humanities.
...
# save to file
final_fragmented %>% 
  mutate(xcor = fragmented_layout[, 1],
...
# save to file
final_clustered %>% 
  mutate(xcor = clustered_layout[, 1],
...
includes a few hubs which are much more connected than the other agents. This
might represent a typical sub-field within the social sciences and humanities.
...
terms of their degree than in the case of network (B). This network might
represent a typical sub-field within the natural sciences.

```{r, fig.height=12, fig.width=5, echo=FALSE, warning=FALSE}
